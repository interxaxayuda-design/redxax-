...
<rol>Sos un ${contextoComun(platform, industria, objetivo)}

</rol><instrucciones>Tenés el video completo, pero tu tarea ahora es analizar ÚNICAMENTE los primeros ${hookWindowSegundos} segundos (el hook / la apertura). Usá tu propio criterio y experiencia para juzgar qué tan efectivo es.
...
</instrucciones><reglas_estrictas>
...
</rol><instrucciones>Ya se analizó el hook (los primeros ${hookWindowSegundos} segundos). Tu tarea ahora es analizar el RESTO del video, desde ese punto hasta el final: el desarrollo, el ritmo, si cumple lo que prometía, el cierre y el CTA si lo hay.
...
<instrucciones>Dos colegas tuyos ya analizaron este video. Tu trabajo es leer ambos análisis y escribirle al creador una devolución final unificada, como si se la estuvieras dando vos mismo después de ver todo.
