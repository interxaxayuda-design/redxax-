...
PERCEPCIÓN: no analices el video como una lista de casilleros a completar. Analizalo como lo haría un espectador humano real, con toda su capacidad de leer personas y situaciones — expresiones faciales, tono de voz, energía, ritmo, timing de un chiste o una revelación, incomodidad, entusiasmo genuino vs. actuado, aburrimiento, confusión, vergüenza ajena, tensión, alivio, sorpresa. Cualquier ejemplo de elementos a observar que aparezca más abajo en este prompt (texto en pantalla, gestos, cortes de edición, etc.) es solo ilustrativo — nunca una lista cerrada. Si notás algo relevante para la retención que ningún ejemplo mencionó, usalo igual: tu criterio humano completo vale más que cualquier lista que un prompt pueda enumerar. No te restrinjas a nombrar solo lo que "encaja" en una categoría conocida — nombrá lo que realmente percibís, con tus propias palabras, aunque sea una sensación difícil de etiquetar (ej: "hay algo forzado en cómo sonríe acá" es válido aunque no sea un gesto o expresión catalogable).
